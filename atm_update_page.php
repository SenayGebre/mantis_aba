...
layout_page_header( sprintf( lang_get( 'atm_update' ), $t_name ) );

layout_page_begin();
?>
<div class="col-md-12 col-xs-12">
	<div class="space-10"></div>
	<form method="post" action="atm_update.php">
	<div class="widget-box widget-color-blue2">
		<div class="widget-header widget-header-small">
			<h4 class="widget-title lighter">
				<?php print_icon( 'fa-atm', 'ace-icon' ); ?>
				<?php echo sprintf( lang_get( 'atm_update' ), $t_name ) ?>
			</h4>
		</div>
		...
		<fieldset>
			...
			<?php echo form_security_field( 'atm_update' ) ?>
			<tr>
				<td class="category">
