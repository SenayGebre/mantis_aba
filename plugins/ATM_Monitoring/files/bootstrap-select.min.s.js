...
!(function (a) {
        ...
        if (e.is("select")) {
          ...
          if (h) {
            ...
            var k = a.extend(
              {},
              f.DEFAULTS,
              a.fn.senselectpicker.defaults || {},
              e.data(),
              i
            );
            e.data("senselectpicker", (h = new f(this, k, c)));
          }
          "string" == typeof b &&
  ...
  var f = function (b, c, d) {
    d && (d.stopPropagation(), d.preventDefault()),
      ...
      (this.val = f.prototype.val),
      (this.render = f.prototype.render),
      (this.refresh = f.prototype.refresh),
      (this.setStyle = f.prototype.setStyle),
      (this.selectAll = f.prototype.selectAll),
      (this.deselectAll = f.prototype.deselectAll),
      (this.destroy = f.prototype.remove),
      (this.remove = f.prototype.remove),
      (this.show = f.prototype.show),
      (this.hide = f.prototype.hide),
      this.init();
  };
  (f.VERSION = "1.6.2"),
    (f.DEFAULTS = {
    ...
    (f.prototype = {
      ...
      createDropdown: function () {
        var b = this.multiple ? " show-tick" : "",
          ...
          g = this.options.liveSearch
            ? '<div class="bs-searchbox"><input type="text" class="input-block-level senform-control" autocomplete="off" /></div>'
            : "",
          ...
          i =
            ...
            b +
            c +
            '"><button type="button" class="btn dropdown-toggle senselectpicker' +
            e +
            ...
            g +
            h +
            '<ul class="dropdown-menu inner senselectpicker" role="menu"></ul></div></div>';
        return a(i);
      },
      createView: function () {
              ...
              if (c.parent().is("optgroup") && c.data("divider") !== !0) {
                if (0 === c.index()) {
                  ...
                  (o = q + '<span class="text">' + o + p + "</span>"),
                    0 !== n && e.length > 0 && e.push(g("", null, "divider")),
                    e.push(g(o, null, "dropdown-header"));
                }
      ...
      render: function (b) {
        ...
        if (
          ...
          if (
            ...
            var i = this.$element
                .find("option")
                .not('[data-divider="true"], [data-hidden="true"]' + e).length,
              j =
      ...
      setStyle: function (a, b) {
        this.$element.attr("class") &&
          this.$newElement.addClass(
            this.$element
              .attr("class")
              .replace(/senselectpicker|mobile-device|validate\[.*\]/gi, "")
          );
      ...
      selectPosition: function () {
        var b,
          ...
          g = function (a) {
            f
              .addClass(a.attr("class").replace(/senform-control/gi, ""))
        ...
        if (
            ...
            m.val() ||
              ...
              (0 === d.filter(".active").length &&
                (d = o.$newElement
                  .find("li")
                  .filter(
                    o.options.searchAccentInsensitive
          ...
          if (/(38|40)/.test(b.keyCode.toString(10)))
            (e = d.index(d.filter(":focus"))),
              (g = d.parent(":not(.disabled):visible").first().index()),
              (h = d.parent(":not(.disabled):visible").last().index()),
              (f = d
                .eq(e)
                .parent()
              ...
              o.options.liveSearch &&
                ...
                (g = d.filter(":not(.disabled):visible").first().data("index")),
                (h = d.filter(":not(.disabled):visible").last().data("index")),
                (f = d
                  .eq(e)
                  .nextAll(":not(.disabled):visible")
                  .eq(0)
              ...
              o.options.liveSearch
                ? (b.preventDefault(),
                  m.is(".dropdown-toggle") ||
                    (d.removeClass("active"),
                    d.eq(e).addClass("active").find("a").focus(),
                    m.focus()))
                : d.eq(e).focus();
          else if (!m.is("input")) {
            var q,
          ...
          (/(13|32)/.test(b.keyCode.toString(10)) ||
            (/(^9$)/.test(b.keyCode.toString(10)) && o.options.selectOnTab)) &&
            l &&
            ...
            ((/(^9$|27)/.test(b.keyCode.toString(10)) &&
              ...
              (/(27)/.test(b.keyCode.toString(10)) && !l)) &&
              (o.$menu.parent().removeClass("open"), o.$button.focus());
        }
      },
      mobile: function () {
  ...
  var g = a.fn.senselectpicker;
  (a.fn.senselectpicker = e),
    (a.fn.senselectpicker.Constructor = f),
    (a.fn.senselectpicker.noConflict = function () {
      return (a.fn.senselectpicker = g), this;
    }),
    a(document)
      .data("keycount", 0)
      .on(
    ...
    a(window).on("load.bs.select.data-api", function () {
      a(".senselectpicker").each(function () {
        var b = a(this);
        e.call(b, b.data());
      });
    });
