...
<?php
		if( $t_can_edit_own ) {
?>
		<form class="form-inline pull-left" action="update_page_atm.php" method="post">
			<fieldset>
		...
		if( $t_can_edit ) { ?>
		<form class="form-inline pull-left" action="delete_atm.php" method="post">
			<fieldset>
