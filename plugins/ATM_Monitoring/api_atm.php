...
function atm_get_branches() {
	...
	$t_query = 'SELECT * FROM {project} WHERE {project}.id IN ( SELECT {project_hierarchy}.child_id FROM {project_hierarchy} WHERE {project_hierarchy}.parent_id = '.db_fetch_array($parent_branch_id)['id'].')';
